                ...
                <div className="max-w-6xl mx-auto px-6 lg:px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-15 items-center">
                        ...
                        <div>
                            <Link
                                href="/blog"
                                className="inline-flex items-center gap-2 px-4 py-2 mb-5 rounded-full border border-[va(--color-26)] bg-[var(--color-25)] text-m font-medium text-[var(--color-18)] hover:bg-[var(--color-13)] hover:text-[var(--color-15)] transition-all duration-200 "
                            >
