      ...
      <div className="flex items-center gap-2 md:gap-5">
        ...
        <div className="flex items-center gap-3 pl-2">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-[var(--color-16)]">Alex Rivera</p>
            <p className="text-xs text-[var(--color-20)]">Administrator</p>
          </div>
          <img 
            src="https://picsum.photos/seed/admin/100/100" 
            alt="Profile" 
            className="w-10 h-10 rounded-xl object-cover ring-2 ring-[var(--color-12)]"
          />
        </div>
      </div>
    </header>
