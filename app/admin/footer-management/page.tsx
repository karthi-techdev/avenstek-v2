...
const FooterManagement: React.FC = () => {
  const [categories, setCategories] = useState<FooterCategory[]>([
    { id: 'cat-1', title: 'Quick Links', order: 1 },
    { id: 'cat-2', title: 'More Links', order: 2 },
  ]);

  const [links, setLinks] = useState<FooterLink[]>([
    { id: '1', categoryId: 'cat-1', title: 'Home', url: '/', order: 1, status: true },
    { id: '2', categoryId: 'cat-1', title: 'About Us', url: '/about', order: 2, status: true },
    { id: '3', categoryId: 'cat-2', title: 'Privacy Policy', url: '/privacy', order: 1, status: true },
    { id: '4', categoryId: 'cat-2', title: 'Terms of Service', url: '/terms', order: 2, status: true },
  ]);
